...
def Xception(include_top=True,
    ...
    x = Conv2D(
        32, (3, 3), strides=(2, 2), use_bias=False, padding='same', name='block1_conv1')(
            img_input)
...
def SE_Xception(include_top=True,
                weights='imagenet',
                input_tensor=None,
                input_shape=None,
                pooling=None,
    ...
    x = MaxPooling2D(
        (3, 3), strides=(2, 2), padding='same', name='block13_pool')(
            x)
    x = Squeeze_excitation_layer(x, 1024)
    x = layers.add([x, residual])
    ...
    x = BatchNormalization(name='block14_sepconv1_bn')(x)
    x = Activation('relu', name='block14_sepconv1_act')(x)
    x = Squeeze_excitation_layer(x, 1536)
    ...
    x = BatchNormalization(name='block14_sepconv2_bn')(x)
    x = Activation('relu', name='block14_sepconv2_act')(x)
    x = Squeeze_excitation_layer(x, 2048)
...
def Squeeze_excitation_layer(input_x, out_dim, ratio=16):
